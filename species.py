...
human_race = go.HumanoidSpecies(name=config.Human,
                                ...
                                sort_key=0,
                                base_resistances_and_affinities={config.sand_passage_cost: -1,
                                                                 config.snow_passage_cost: -1,
                                                                 config.ice_passage_cost: -1,
                                                                 config.wading_passage_cost: -2},
...
dwarf_race = go.HumanoidSpecies(name=config.Dwarf,
                                ...
                                sort_key=1,
                                base_effect_modifiers={config.heavy_armor_skill: 1.5},
                                base_resistances_and_affinities={config.drunk_effect: -20},
                                fist_weapon=items.Fist,
                                clothes=items.Clothes)
...
orc_race = go.HumanoidSpecies(name=config.Orc,
                              ...
                              sort_key=4,
                              base_resistances_and_affinities={config.sick_effect: -20},
                              fist_weapon=items.Fist,
                              clothes=items.Clothes)
troll_race = go.HumanoidSpecies(name=config.Troll,
                                ...
                                sort_key=5, consumable_types=[items.Rock, items.GoldOre,
                                                              items.IronOre, items.SilverOre],
                                base_resistances_and_affinities={config.hunger_rock_effect: 10,
...
kraken_race = go.HumanoidSpecies(name=config.Kraken,
                                 ...
                                 sort_key=7, base_effect_modifiers={config.max_energy_modifier: 1.2,
                                                                    config.monster_harvesting_skill: 2.5},
                                 fist_weapon=items.Fist,
                                 clothes=items.Clothes)
...
water_elemental_race = go.HumanoidSpecies(name=config.WaterElemental,
                                          ...
                                          sort_key=11,
                                          base_resistances_and_affinities={config.hunger_water_effect: 20},
                                          fist_weapon=items.Fist,
                                          clothes=items.Clothes)
fae_race = go.HumanoidSpecies(name=config.Fae,
                              ...
                              sort_key=12,
                              base_resistances_and_affinities={config.hunger_meat_effect: -20},
                              fist_weapon=items.Fist,
                              clothes=items.Clothes)
